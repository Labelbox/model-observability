...
from resources.settings import (PROJECT, DATASET, BBOX_FEATURE_SCHEMA_ID,
                                TEXT_FEATURE_SCHEMA_ID, client)

logger = logging.getLogger("upload")


def mal_upload(image_bytes, external_id, boxes, scores, image_h, image_w):
    ndjsons = []
